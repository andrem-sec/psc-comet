...
No install. No API. Just copy and run.

**68 skills. 13 agents. 25 hooks. 46 commands.**
...
**Bug fix:** `/fix` — debug → regression test → fix → review
...
6. **Drop-in portable** — no install, no API keys required, works on Windows/Linux/macOS
